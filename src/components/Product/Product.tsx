                ...
                <div className='bg-custom-light-green w-[800px] h-[410px] ml-[15px] mr-[15px]'>
                    <div className='flex '>
                        <div className='w-[500px]'>
                            ...
                            <Image src="/images/products/handsome.png" alt='/images/products/handsome.png' width={400} height={400} />
                        </div>
                        <div>
                ...
                <div className='bg-custom-prink-color h-[415px] ml-[15px] mr-[15px] flex flex-col'>
                    <div>
                        ...
                        <div className='ml-[3rem]'>
                            <Image src="/images/products/cheerful-smiling-woman.png" alt='images' width={263} height={263} />
                        </div>
                    </div>
                    <div></div>
                </div>
