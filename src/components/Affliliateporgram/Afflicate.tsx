...
const Afflicate: React.FC = () => {
    return (
        <div style={{ backgroundImage: `url('/images/afflicate/Background.png')`, backgroundSize: 'cover', backgroundPosition: 'center' }}>
            ...
            <div className='flex'>
                <div className='flex p-[6rem] w-[57rem] '>
                    <div >
                        ...
                        <p className='text-custom-black text-[2rem] mt-[1rem] font-semibold' >AFFILIATE PROGRAM THAT FITS</p>

                        <p className='text-custom-green mt-[1rem] font-semibold text-[2rem]'>EVERYONE</p>
